  ...
  const footerSections = [
    {
      ...
      content: {
        type: "text",
        text: "Somos una compañía que se encuentra a la vanguardia en el desarrollo de soluciones para su empresa, Creamos aplicaciones profesionales que brindan ventajas competitivas a su negocio a través de las herramientas de uso diario para satisfacer necesidades....",
      },
    },
    {
      title: "PRODUCTOS",
      content: {
        type: "links",
        links: [
          { label: "Salestrack", path: "https://pure.ec/" },
          { label: "RouteTrack", path: "https://pure.ec/" },
          { label: "SendTrack", path: "https://pure.ec/" },
          { label: "ProductoActivo", path: "https://pure.ec/" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        contacts: [
          ...
          { icon: Mail, text: "info@pure.ec" },
          { icon: Phone, text: "+593 98 336 7818" },
    ...
    >
      <div className="footer-content">
        ...
        <motion.div className="footer-bottom" variants={itemVariants}>
          ...
          >
            {currentYear} Copyright: Derechos reservados - PURE TECH 2025
          </motion.p>
