...
/**
 * API de autenticación con soporte para sidebar dinámico
 */
...
export const loginUser = async (email, password) => {
  ...
  return {
    ...userWithoutPassword,
    databaseData,
    sidebarConfig, // ✨ Configuración del sidebar (null si no existe archivo específico)
  }
}
 ...
 */
export const loadUserSidebar = async (databaseName) => {
  try {
    // Intentar cargar sidebar específico para esta base de datos
    ...
    // Si no existe, retornar null para usar el sidebar por defecto del componente
...
export const loginUserAPI = async (email, password) => {
  try {
    ...
    // - sidebarConfig: configuración del sidebar del usuario (opcional)
